        ...
        <div class="random-product-container">
            ...
            <div class="random-product-container__content">
                <div class="item-product">
                    <div class="item-product__title-product"><a href="/product/<?php echo $productRandom['id']; ?>" class="item-product__title-product__link"><?php echo $productRandom['name']; ?></a></div>
                    <div class="item-product__thumbnail"><a href="/product/<?php echo $productRandom['id']; ?>" class="item-product__thumbnail__link"><img src="/template/img/cover/<?php echo $productRandom['image']; ?>" alt="Preview-image" class="item-product__thumbnail__link__img"></a></div>
                    <div class="item-product__description">
                        <div class="item-product__description__products-price"><span class="products-price"><?php echo $productRandom['price']; ?> руб</span></div>
